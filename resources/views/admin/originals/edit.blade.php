                  ...
                  <div class="flex">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                      ...
                      <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="name" name="fe" type="text" value="{{ $original->fe }}">
                        @error('pac')
                          <p class="text-red-500 text-xs italic">{{$message}}</p>
                        @enderror                  
                      </div>
